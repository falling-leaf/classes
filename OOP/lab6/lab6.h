#include <bits/stdc++.h>
using namespace std;
//note: as for the feature of vector, we suppose that:
//when the capacity is set, it must be 1.5*size; and the capacity is more than 5.
//the comments are copied from the question.
template <class T>
class Vector {
public:
